...
## Fixed
- [X] Documentation: Readme HTML internal styling should better match old MD format (but with more flair)
- [X] Documentation: Designdoc HTML internal styling should better match old MD format (but with more flair)
- [X] Documentation: Convert Readme MD to ReadMe HTML with its own internal styling
- [X] Documentation: Convert Designdoc MD to Designdoc HTML with its own internal styling</
- [X] Documentation: Typographical errors in Readme HTML
- [X] Documentation: Typographical errors in Designdoc HTML
- [X] Content: Create Quotegenerator JS concatenator to combine multiple quotes arrays
- [X] Content: Split single array into multiple themed arrays in Quotedata JS
- [X] Graphics: Give that last picture in Faq HTML a hybrid gamified overlay
- [X] Graphics: Better match section icon and page header color schema
- [X] Graphics: Make sure the stroke width and filled/unfilled better ratio matches across all section icons
- [X] Layouts: Add gentle moonlight glow effect to HTML header text
- [X] Layouts: Soften that blaze white text on HTML pages to a muted pearl gray
- [X] Layouts: Create deignated CSS stylesheet for Mermaid... HTML pages
- [X] Menus: Faq HTML menu font mismatches the other HTML pages
- [X] Menus: Button activation styling glitch
- [X] Mermaid: Convert diagrams from hardcoded backtick format to embedded Mermaid... HTML files
- [X] Mermaid: Syntax error in Mermaidflowchart HTML preventing svg rendering
- [X] Mermaid: Syntax error in Mermaidganttchart HTML preventing svg rendering
- [X] Mermaid: Mermaidganttchart HTML label text not appearing within rect
- [X] Tables: Formatting errors in Designdoc HTML 'Website Build Options' table
